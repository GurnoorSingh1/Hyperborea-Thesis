...
INPUT_DIR = Path(r"C:\Users\Gurnoor\Documents\UVA\Scriptie\dataset\last")
OUTPUT_DIR = Path(r"C:\Users\Gurnoor\Documents\UVA\Scriptie\dataset\last")
...
def check_webui_connection() -> None:
    try:
        ...
        raise RuntimeError(
            ...
            "http://127.0.0.1:7860 with --api enabled."
        ) from exc
